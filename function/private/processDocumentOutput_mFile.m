...
partsMarkdown = regexprep(partsMarkdown,"\\item(.*)\n","-$1\n", 'dotexceptnewline'); % for things of the form "   \item ...  "
partsMarkdown = erase(partsMarkdown,["\begin{itemize}","\end{itemize}","\setlength{\itemsep}{-1ex}"+newline]);
